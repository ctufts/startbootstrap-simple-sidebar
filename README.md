This repo is a simple example using the Start Bootstrap Simple Sidebar. When selecting an element from the menu, the element name is printed to the screen.  For more information on the Simple Sidebar please see the original README below. 
